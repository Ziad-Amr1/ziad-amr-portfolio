(() => {
  ...
  var Icon = (0, import_react20.forwardRef)(
    ({
      ...
      iconNode,
      ...rest
    }, ref) => (0, import_react20.createElement)(
      "svg",
      {
        ref,
        ...defaultAttributes,
  ...
  var createLucideIcon = (iconName, iconNode) => {
    const Component2 = (0, import_react21.forwardRef)(
      ({ className, ...props }, ref) => (0, import_react21.createElement)(Icon, {
        ref,
        iconNode,
  ...
  function useTypingEffect(words = [], {
    ...
    const [charIndex, setCharIndex] = (0, import_react24.useState)(0);
    const [isDeleting, setIsDeleting] = (0, import_react24.useState)(false);
    const [blink, setBlink] = (0, import_react24.useState)(true);
    const [isPaused, setIsPaused] = (0, import_react24.useState)(!autoStart);
    const timerRef = (0, import_react24.useRef)(null);
    const safeWords = (0, import_react24.useMemo)(() => Array.isArray(words) ? words : [], [words]);
    const currentWord = safeWords[index % safeWords.length] ?? "";
    (0, import_react24.useEffect)(() => {
      if (!safeWords.length || isPaused) return;
      const delay2 = isDeleting ? deletingSpeed : typingSpeed;
    ...
    (0, import_react24.useEffect)(() => {
      if (isPaused) return;
      const id3 = setInterval(() => setBlink((b) => !b), blinkSpeed);
  ...
  // src/components/Hero.jsx
  function Hero() {
    const titles = (0, import_react25.useMemo)(
      () => [
        "Frontend Developer",
        "Graphic Designer",
        "Architect",
    ...
    const socials = [
      {
        id: "linkedin",
        icon: /* @__PURE__ */ import_react25.default.createElement(FaLinkedin, null),
        link: "https://www.linkedin.com/in/ziadamrsaid/"
      },
      {
        id: "github",
        icon: /* @__PURE__ */ import_react25.default.createElement(FaGithub, null),
        link: "https://github.com/Ziad-Amr1/"
      },
      {
        id: "behance",
        icon: /* @__PURE__ */ import_react25.default.createElement(FaBehance, null),
        link: "https://www.behance.net/ziadamrsaid"
      },
      {
        id: "dribbble",
        icon: /* @__PURE__ */ import_react25.default.createElement(FaDribbble, null),
    ...
    return /* @__PURE__ */ import_react25.default.createElement(
      ...
      /* @__PURE__ */ import_react25.default.createElement("div", { className: "absolute inset-0 -z-10 overflow-hidden" }, /* @__PURE__ */ import_react25.default.createElement(
        "div",
        {
          className: "\r\n          absolute\r\n          top-[-200px]\r\n          left-[-150px]\r\n\r\n          w-[500px]\r\n          h-[500px]\r\n\r\n          rounded-full\r\n\r\n          bg-blue-500/20\r\n          dark:bg-blue-500/20\r\n\r\n          blur-[140px]\r\n          "
        }
        ...
        /* @__PURE__ */ import_react25.default.createElement(
          ...
          /* @__PURE__ */ import_react25.default.createElement(
            ...
            /* @__PURE__ */ import_react25.default.createElement(
              ...
              text,
              /* @__PURE__ */ import_react25.default.createElement("span", { className: "ml-1" }, blink ? "|" : " ")
            ),
            /* @__PURE__ */ import_react25.default.createElement(
              "p",
              {
              ...
              "Passionate about crafting interactive, responsive, and visually engaging digital experiences that merge creativity with functionality."
            ),
            /* @__PURE__ */ import_react25.default.createElement(
              "div",
              {
              ...
              /* @__PURE__ */ import_react25.default.createElement(
                ...
                /* @__PURE__ */ import_react25.default.createElement(Download, { className: "w-5 h-5" }),
                "Download CV"
              )
            ),
            /* @__PURE__ */ import_react25.default.createElement(
          ...
          /* @__PURE__ */ import_react25.default.createElement(
            ...
            /* @__PURE__ */ import_react25.default.createElement(
              ...
              Array.from({
                length: 16
              }).map((_, i) => /* @__PURE__ */ import_react25.default.createElement(
                "span",
                {
                  key: i,
                  className: "\r\n                  w-1.5\r\n                  h-1.5\r\n\r\n                  rounded-full\r\n\r\n                  bg-blue-400\r\n                  "
